...
Object.assign(window.SIGILRPG_LOCALES.pl.strings, {
  ...
  'Clean yourself, refresh your senses, stretch, and regain composure. This additional budget restores only AUR and SEN.': 'Odśwież się, wyostrz zmysły, rozciągnij ciało i odzyskaj opanowanie. Ten dodatkowy limit przywraca wyłącznie AUR i SEN.',
  'Proper rest and physical care restore strength and fine control. This additional budget restores only STR and DEX.': 'Porządny odpoczynek i zadbanie o ciało przywracają siłę oraz precyzję ruchów. Ten dodatkowy limit przywraca wyłącznie STR i DEX.',
  ...
  'Allocate whole tiers only to eligible attributes, without exceeding their maximums.': 'Przydzielaj całe poziomy kości wyłącznie do dozwolonych atrybutów, nie przekraczając ich wartości maksymalnych.',
  ...
  'Use HEAL to choose tiers to recover.': 'Użyj LECZ, aby wybrać poziomy kości do odzyskania.',
  'Later rests include earlier stages. Each budget rounds down; unused tiers are lost, not transferred.': 'Dłuższe odpoczynki obejmują wcześniejsze etapy regeneracji. Każdy limit jest zaokrąglany w dół; niewykorzystane poziomy kości przepadają i nie przechodzą na inne etapy.',
